    ...
    public class DistributionController : ControllerBase
    {
        ...
        public async Task<ActionResult> UpdateSOSDistribution(int sosDistribution_Id, SOSDistributionForUpdateDto sosUpdateEntity)
        {
            try
            {
                ...
                List<SOSDistributionOperationSequenceForUpdateDto> filteredSOSOperationSequenceList = sosUpdateEntity.SOSDistributionOperationSequence.Where(t => t.SOSDistributionOperationSequenceId <= 0).ToList() ?? new List<SOSDistributionOperationSequenceForUpdateDto>();
                ...
                if (_sosDistribution == null) _sosDistribution = new SOSDistribution();
            ...
            {
                return NotFound($"Error: {ex.Message} /n Inner: {ex.InnerException}");
            }
