        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<JobObservation>()
                ...
                new JobObservation()
                {
                    ...
                    OperationId = 1,
                    Type = 2,
                    StartDate = DateTime.Parse("19/4/2023 12:00:00"),
                    EndDate = DateTime.Parse("19/4/2023 13:00:00"),
                    PlannedStartDate = DateTime.Parse("19/4/2023 00:00:00"),
                    PlannedEndDate = DateTime.Parse("19/4/2023 00:00:00"),
                    FinishedDate = null,
                    Status = 1,
                    Option = 1,
                    SupervisorId = 1,
